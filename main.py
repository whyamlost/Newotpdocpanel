...
# ===================== START WITH IMAGE =====================
# ===================== START WITH IMAGE & CLEAN WELCOME =====================
...
def start(msg):
    ...
    try:
        bot.send_photo(msg.chat.id, 
                      "https://i.postimg.cc/zB6S01g5/file-00000000ef1c71fd8fb6477fae06ddbb.png", 
                      caption="✅ *Simp OTP Bot Started Successfully*", 
                      parse_mode="Markdown")
    except:
        pass

    # Clean welcome card like your example
    welcome_text = (
        "🚀 **Welcome to Simp OTP Bot**\n\n"
